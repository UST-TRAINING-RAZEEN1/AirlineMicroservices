...
mongoose.connect('mongodb://mongodb/flightdb', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.get('/flights/:id/passengers', async (req, res) => {
    ...
    try {
        const passengers = await axios.get(`http://passenger-microservice:3002/passengersByFlightId?flightId=${flightId}`);
